...
This connector uses Jira Basic Auth, requiring an email address and API token. The connector supports both **regular user accounts** and **Atlassian service accounts**. To use this connector, you need:
