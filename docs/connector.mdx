...
- Per-project participant listing pages through all participants using a page size of 1,000, but each project incurs one extra trailing request beyond the pages that returned data, since pagination only stops on an empty page.
