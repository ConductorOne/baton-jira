...
func NewTypedSessionCache[T any](cache types.SessionCache, codec Codec[T]) *TypedSessionCache[T] {
...
func (t *TypedSessionCache[T]) Get(ctx context.Context, key string, opt ...types.SessionCacheOption) (T, bool, error) {
	var zero T
...
func (t *TypedSessionCache[T]) Set(ctx context.Context, key string, value T, opt ...types.SessionCacheOption) error {
...
func (t *TypedSessionCache[T]) GetMany(ctx context.Context, keys []string, opt ...types.SessionCacheOption) (map[string]T, error) {
...
func (t *TypedSessionCache[T]) SetMany(ctx context.Context, values map[string]T, opt ...types.SessionCacheOption) error {
